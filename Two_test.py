...
def adding_new_question(ID_test, rec_queschen, rec_answerre_1, rec_answerre_2, rec_answerre_3, correct_answer,
                        question_numbers):
    import sqlite3
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS all_tests(
        ...
        """)
    new_test_record_list = [ID_test, question_numbers, rec_queschen, rec_answerre_1, rec_answerre_2, rec_answerre_3,
                            correct_answer]
    ...
    print('')
    print('adding a new question', ID_test, rec_queschen, rec_answerre_1, rec_answerre_2, rec_answerre_3,
